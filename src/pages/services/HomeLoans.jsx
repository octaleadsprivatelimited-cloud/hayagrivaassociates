...
export default function HomeLoans() {
  const features = [
    {
      ...
      desc: 'Assistance with home loan application and processing',
      color: 'from-blue-500 to-blue-600'
    },
    {
      icon: ClipboardDocumentListIcon,
      title: 'Documentation',
      desc: 'Complete documentation support for loan applications',
      color: 'from-purple-500 to-purple-600'
    },
    {
      icon: BanknotesIcon,
      title: 'Best Rates',
      desc: 'Guidance to find the best home loan rates and terms',
      color: 'from-green-500 to-green-600'
    },
    {
      icon: CheckCircleIcon,
      title: 'Processing Support',
      desc: 'End-to-end support throughout the loan process',
  ...
  const services = [
    ...
    'Property valuation for loans',
    'Loan eligibility assessment',
    'Rate comparison and guidance',
    'Application processing support',
    'Disbursement assistance'
  ];

  const process = [
    { step: '1', title: 'Eligibility Check', desc: 'Assess loan eligibility and requirements', icon: ClipboardDocumentListIcon },
    { step: '2', title: 'Documentation', desc: 'Prepare and organize all required documents', icon: DocumentTextIcon },
    { step: '3', title: 'Application', desc: 'Submit loan application to selected lender', icon: PencilIcon },
    { step: '4', title: 'Processing', desc: 'Coordinate and follow up on loan processing', icon: Cog6ToothIcon },
    { step: '5', title: 'Disbursement', desc: 'Assist with loan approval and disbursement', icon: CheckCircleIcon }
  ];

  return (
    <>
      <Helmet>
        <title>Home Loans - Hayagriva Associates</title>
        <meta name="description" content="Assistance with home loan applications and processing for residential properties. Complete documentation and processing support." />
      </Helmet>
          ...
          <div className="container-default w-full">
            <div className="max-w-3xl">
              ...
              <p className="text-xl sm:text-2xl text-white drop-shadow-[0_2px_8px_rgba(0,0,0,0.7)] leading-relaxed mb-8">
                Assistance with home loan applications and processing for residential properties
              </p>
        ...
        <div className="container-default">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <h2 className="text-4xl sm:text-5xl font-bold text-slate-900 mb-6">Home Loan Assistance Services</h2>
              <div className="w-24 h-1 bg-brand-primary mx-auto mb-6"></div>
            </div>
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                <p className="text-xl text-slate-700 leading-relaxed">
                  We provide <strong className="text-brand-primary">complete assistance</strong> with home loan applications and processing for residential properties. Our services help simplify the loan application process.
                </p>
                <p className="text-lg text-slate-600 leading-relaxed">
                  From documentation to loan disbursement, we guide you through the entire home loan process, ensuring all requirements are met and helping you find the best loan options.
                </p>
              </div>
              <div className="bg-gradient-to-br from-brand-primary/10 via-brand-primary/5 to-slate-50 rounded-2xl p-8 border-2 border-brand-primary/20">
                ...
                <div className="space-y-4">
                  {['Expert guidance', 'Complete documentation', 'Best loan options', 'Processing support'].map((item, i) => (
      ...
      <AnimatedSection className="py-20 sm:py-24 bg-gradient-to-b from-slate-50 to-white">
        <div className="container-default">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl sm:text-5xl font-bold text-slate-900 mb-4">Loan Services Offered</h2>
            <p className="text-xl text-slate-600 max-w-2xl mx-auto">
              Comprehensive home loan assistance services
            </p>
        ...
        <div className="container-default">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <h2 className="text-4xl sm:text-5xl font-bold text-slate-900 mb-6">Complete Loan Services</h2>
              <p className="text-xl text-slate-600">Full range of home loan assistance services</p>
              <div className="w-24 h-1 bg-brand-primary mx-auto mt-6"></div>
            </div>
      ...
      <AnimatedSection className="py-20 sm:py-24 bg-gradient-to-b from-slate-50 to-white">
        <div className="container-default">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-600 max-w-2xl mx-auto">
              Systematic approach to home loan processing
            </p>
            <div className="w-24 h-1 bg-brand-primary mx-auto mt-6"></div>
          </div>
      ...
      <AnimatedSection className="py-20 sm:py-24 bg-gradient-to-br from-brand-primary via-brand-primary to-slate-800 text-white">
        <div className="container-default">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h2 className="text-4xl sm:text-5xl font-bold mb-6">Need Home Loan Assistance?</h2>
            <p className="text-xl text-white/90 mb-10 max-w-2xl mx-auto leading-relaxed">
              Get professional assistance with home loan applications. Contact us today.
            </p>
