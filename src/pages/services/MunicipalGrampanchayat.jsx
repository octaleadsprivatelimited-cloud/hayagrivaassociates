...
export default function MunicipalGrampanchayat() {
  const features = [
    {
      icon: BuildingOffice2Icon,
      title: 'Municipal Building Permissions',
      desc: 'Complete assistance for obtaining building permissions from municipal authorities',
      color: 'from-blue-500 to-blue-600'
    },
    {
      icon: HomeModernIcon,
      title: 'Grampanchayat Approvals',
      desc: 'Expert guidance for Grampanchayat building permissions and rural property approvals',
      color: 'from-purple-500 to-purple-600'
    },
    {
      icon: Squares2X2Icon,
      title: 'Plan Verification',
      desc: 'Comprehensive verification of building plans as per municipal and Grampanchayat norms',
      color: 'from-green-500 to-green-600'
    },
    {
      icon: CheckCircleIcon,
      title: 'Compliance Documentation',
      desc: 'Complete documentation for municipal and Grampanchayat compliance and approvals',
      color: 'from-orange-500 to-orange-600'
    }
  ];

  const services = [
    'Municipal building permission assistance',
    'Grampanchayat building permission support',
    'Layout approval for municipal areas',
    'Village land building permissions',
    'Building plan verification and approval',
    'Property tax assessment surveys',
    'Municipal and Grampanchayat boundary surveys',
  ...
  return (
    <>
      <Helmet>
        <title>Municipal & Grampanchayat Building Permission - Hayagriva Associates</title>
        <meta name="description" content="Complete assistance for obtaining building permissions from Municipal and Grampanchayat authorities. Expert guidance for all approval processes." />
      </Helmet>
      ...
      <section className="relative h-[50vh] sm:h-[60vh] lg:h-[70vh] overflow-hidden">
        <div className="absolute inset-0">
          <img
            ...
            alt="Municipal & Grampanchayat Building Permission"
          ...
          <div className="container-default w-full">
            <div className="max-w-3xl">
              ...
              <p className="text-xl sm:text-2xl text-white drop-shadow-[0_2px_8px_rgba(0,0,0,0.7)] leading-relaxed mb-8">
                Complete assistance for obtaining building permissions from Municipal and Grampanchayat authorities
              </p>
        ...
        <div className="container-default">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <h2 className="text-4xl sm:text-5xl font-bold text-slate-900 mb-6">Building Permission Services</h2>
              <div className="w-24 h-1 bg-brand-primary mx-auto mb-6"></div>
            </div>
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                <p className="text-xl text-slate-700 leading-relaxed">
                  We provide <strong className="text-brand-primary">complete assistance</strong> for obtaining building permissions from both Municipal and Grampanchayat authorities. Our expertise covers all aspects of the approval process, from documentation to final approval.
                </p>
                <p className="text-lg text-slate-600 leading-relaxed">
                  Whether you're building in urban municipal areas or rural Grampanchayat regions, our team understands the specific requirements and ensures all documentation and plans comply with local regulations.
                </p>
              </div>
              <div className="bg-gradient-to-br from-brand-primary/10 via-brand-primary/5 to-slate-50 rounded-2xl p-8 border-2 border-brand-primary/20">
                ...
                <div className="space-y-4">
                  {['Municipal & Grampanchayat expertise', 'Complete documentation support', 'Fast approval process', 'Ongoing follow-up'].map((item, i) => (
      ...
      <AnimatedSection className="py-20 sm:py-24 bg-gradient-to-b from-slate-50 to-white">
        <div className="container-default">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl sm:text-5xl font-bold text-slate-900 mb-4">Permission Services Offered</h2>
            <p className="text-xl text-slate-600 max-w-2xl mx-auto">
              Comprehensive building permission assistance for Municipal and Grampanchayat areas
            </p>
        ...
        <div className="container-default">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <h2 className="text-4xl sm:text-5xl font-bold text-slate-900 mb-6">Complete Permission Services</h2>
              <p className="text-xl text-slate-600">Full range of building permission and approval services</p>
              <div className="w-24 h-1 bg-brand-primary mx-auto mt-6"></div>
            </div>
      ...
      <AnimatedSection className="py-20 sm:py-24 bg-gradient-to-b from-slate-50 to-white">
        <div className="container-default">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-600 max-w-2xl mx-auto">
              Systematic approach ensuring successful approval
            </p>
            <div className="w-24 h-1 bg-brand-primary mx-auto mt-6"></div>
          </div>
      ...
      <AnimatedSection className="py-20 sm:py-24 bg-gradient-to-br from-brand-primary via-brand-primary to-slate-800 text-white">
        <div className="container-default">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h2 className="text-4xl sm:text-5xl font-bold mb-6">Need Building Permission Assistance?</h2>
            <p className="text-xl text-white/90 mb-10 max-w-2xl mx-auto leading-relaxed">
              Get professional assistance for Municipal and Grampanchayat building permissions. Contact us today.
            </p>
