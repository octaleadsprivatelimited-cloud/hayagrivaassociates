...
export default function VastuPlans() {
  const features = [
    {
      icon: HomeIcon,
      title: 'Vastu-Compliant Design',
      desc: 'Architectural plans designed according to Vastu Shastra principles',
      color: 'from-blue-500 to-blue-600'
    },
    {
      icon: Squares2X2Icon,
      title: 'Working Plans',
      desc: 'Detailed working drawings for construction execution',
      color: 'from-purple-500 to-purple-600'
    },
    {
      icon: ClipboardDocumentListIcon,
      title: 'Approval Ready',
      desc: 'Plans prepared for municipal and Grampanchayat approvals',
      color: 'from-green-500 to-green-600'
    },
    {
      icon: CheckCircleIcon,
      title: 'Expert Consultation',
      desc: 'Professional guidance on Vastu principles and building design',
  ...
  const process = [
    { step: '1', title: 'Site Analysis', desc: 'Analyze site orientation and Vastu requirements', icon: ChartBarIcon },
  ...
  return (
    <>
      <Helmet>
        <title>Vastu Plans / Working Plans - Hayagriva Associates</title>
        <meta name="description" content="Architectural plans designed according to Vastu principles and working drawings for construction. Professional Vastu consultation services." />
      </Helmet>
      ...
      <section className="relative h-[50vh] sm:h-[60vh] lg:h-[70vh] overflow-hidden">
        ...
        <div className="absolute inset-0">
          <img
            src="/images/Vastu Plans  Working Plans.jpeg"
          ...
          <div className="container-default w-full">
            <div className="max-w-3xl">
              ...
              <p className="text-xl sm:text-2xl text-white drop-shadow-lg leading-relaxed mb-8">
                Architectural plans designed according to Vastu principles and working drawings for construction
              </p>
        ...
        <div className="container-default">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <h2 className="text-4xl sm:text-5xl font-bold text-slate-900 mb-6">Vastu Plans & Working Drawings</h2>
              <div className="w-24 h-1 bg-brand-primary mx-auto mb-6"></div>
            </div>
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                <p className="text-xl text-slate-700 leading-relaxed">
                  We provide <strong className="text-brand-primary">Vastu-compliant architectural plans</strong> and detailed working drawings for your construction projects. Our designs combine traditional Vastu principles with modern construction practices.
                </p>
                <p className="text-lg text-slate-600 leading-relaxed">
                  Our team of experienced architects and designers ensures that your building plans are not only Vastu-compliant but also practical, functional, and ready for approval and construction.
                </p>
              </div>
              <div className="bg-gradient-to-br from-brand-primary/10 via-brand-primary/5 to-slate-50 rounded-2xl p-8 border-2 border-brand-primary/20">
                ...
                <div className="space-y-4">
                  {['Vastu expertise', 'Approval-ready plans', 'Detailed working drawings', 'Professional consultation'].map((item, i) => (
      ...
      <AnimatedSection className="py-20 sm:py-24 bg-gradient-to-b from-slate-50 to-white">
        <div className="container-default">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl sm:text-5xl font-bold text-slate-900 mb-4">Design Services Offered</h2>
            <p className="text-xl text-slate-600 max-w-2xl mx-auto">
              Comprehensive Vastu planning and working drawing services
            </p>
        ...
        <div className="container-default">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <h2 className="text-4xl sm:text-5xl font-bold text-slate-900 mb-6">Complete Design Services</h2>
              <p className="text-xl text-slate-600">Full range of Vastu planning and working drawing services</p>
              <div className="w-24 h-1 bg-brand-primary mx-auto mt-6"></div>
            </div>
      ...
      <AnimatedSection className="py-20 sm:py-24 bg-gradient-to-b from-slate-50 to-white">
        <div className="container-default">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-600 max-w-2xl mx-auto">
              Systematic approach to Vastu-compliant design
            </p>
            <div className="w-24 h-1 bg-brand-primary mx-auto mt-6"></div>
          </div>
      ...
      <AnimatedSection className="py-20 sm:py-24 bg-gradient-to-br from-brand-primary via-brand-primary to-slate-800 text-white">
        <div className="container-default">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h2 className="text-4xl sm:text-5xl font-bold mb-6">Need Vastu Plans or Working Drawings?</h2>
            <p className="text-xl text-white/90 mb-10 max-w-2xl mx-auto leading-relaxed">
              Get professional Vastu-compliant plans and working drawings. Contact us today.
            </p>
