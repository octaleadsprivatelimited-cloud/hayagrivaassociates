  ...
  const features = [
    {
      ...
      desc: 'Contemporary and aesthetically pleasing elevation designs',
    ...
    },
    {
      ...
      desc: '3D renderings to visualize your building elevation',
      color: 'from-green-500 to-green-600'
    },
    {
      icon: CheckCircleIcon,
      title: 'Approval Ready',
      desc: 'Elevation designs prepared for approval submission',
        ...
        <div className="container-default">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <h2 className="text-4xl sm:text-5xl font-bold text-slate-900 mb-6">Building Elevation Design Services</h2>
              <div className="w-24 h-1 bg-brand-primary mx-auto mb-6"></div>
            </div>
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                <p className="text-xl text-slate-700 leading-relaxed">
                  We create <strong className="text-brand-primary">professional building elevation designs</strong> that enhance both the aesthetic appeal and functionality of your building. Our designs are modern, practical, and ready for approval.
                </p>
                <p className="text-lg text-slate-600 leading-relaxed">
                  Our team of experienced designers creates elevation designs that reflect your vision while ensuring compliance with local building regulations and approval requirements.
                </p>
              </div>
              <div className="bg-gradient-to-br from-brand-primary/10 via-brand-primary/5 to-slate-50 rounded-2xl p-8 border-2 border-brand-primary/20">
                ...
                <div className="space-y-4">
                  {['Modern design expertise', '3D visualization', 'Approval-ready designs', 'Custom solutions'].map((item, i) => (
        ...
        <div className="container-default">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-600 max-w-2xl mx-auto">
              Comprehensive building elevation design services
            </p>
        ...
        <div className="container-default">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <h2 className="text-4xl sm:text-5xl font-bold text-slate-900 mb-6">Complete Elevation Design Services</h2>
              <p className="text-xl text-slate-600">Full range of building elevation design services</p>
              <div className="w-24 h-1 bg-brand-primary mx-auto mt-6"></div>
            </div>
      ...
      <AnimatedSection className="py-20 sm:py-24 bg-gradient-to-b from-slate-50 to-white">
        <div className="container-default">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-600 max-w-2xl mx-auto">
              Systematic approach to elevation design
            </p>
            <div className="w-24 h-1 bg-brand-primary mx-auto mt-6"></div>
          </div>
      ...
      <AnimatedSection className="py-20 sm:py-24 bg-gradient-to-br from-brand-primary via-brand-primary to-slate-800 text-white">
        <div className="container-default">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h2 className="text-4xl sm:text-5xl font-bold mb-6">Need Building Elevation Design?</h2>
            <p className="text-xl text-white/90 mb-10 max-w-2xl mx-auto leading-relaxed">
              Get professional building elevation designs. Contact us today.
            </p>
