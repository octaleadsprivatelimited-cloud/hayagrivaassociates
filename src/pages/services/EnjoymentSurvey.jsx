...
export default function EnjoymentSurvey() {
  ...
  const process = [
    { step: '1', title: 'Document Review', desc: 'Analysis of records and title documents', icon: '📄' },
    { step: '2', title: 'Field Survey', desc: 'On-ground measurement and verification', icon: '📏' },
    { step: '3', title: 'Comparison', desc: 'Matching ground reality with records', icon: '🔍' },
    { step: '4', title: 'Report Preparation', desc: 'Detailed findings and discrepancies', icon: '📊' },
    { step: '5', title: 'Delivery', desc: 'Comprehensive report with recommendations', icon: '✅' }
  ];
  ...
  return (
    <>
      ...
      <section className="relative h-[50vh] sm:h-[60vh] lg:h-[70vh] overflow-hidden">
        <img src={imagePath} alt="Enjoyment Survey" className="w-full h-full object-cover" loading="eager" />
