...
export default function Municipal() {
  const features = [
    {
      icon: '🏛️',
      title: 'Municipal Layout Approvals',
      desc: 'Expert assistance with municipal layout approvals and compliance',
      color: 'from-blue-500 to-blue-600'
    },
    {
      icon: '📐',
      title: 'Building Plan Verification',
      desc: 'Comprehensive verification of building plans as per municipal norms',
      color: 'from-purple-500 to-purple-600'
    },
    {
      icon: '📋',
      title: 'Property Tax Assessment',
      desc: 'Accurate property tax assessment and documentation support',
      color: 'from-green-500 to-green-600'
    },
    {
      icon: '✅',
      title: 'Compliance Documentation',
      desc: 'Complete documentation for municipal compliance and approvals',
      color: 'from-orange-500 to-orange-600'
    }
  ];

  const services = [
    'Municipal layout approval assistance',
    'Building plan verification and approval',
    'Property tax assessment surveys',
    'Municipal boundary surveys',
    'Zoning compliance verification',
    'Municipal record documentation'
  ];

  const process = [
    { step: '1', title: 'Documentation Review', desc: 'Review municipal requirements and existing documents', icon: '📄' },
    { step: '2', title: 'Site Survey', desc: 'Conduct comprehensive site survey', icon: '📏' },
    { step: '3', title: 'Plan Preparation', desc: 'Prepare plans as per municipal standards', icon: '📐' },
    { step: '4', title: 'Submission Support', desc: 'Assist with municipal submission process', icon: '📋' },
    { step: '5', title: 'Approval Follow-up', desc: 'Follow up and coordinate for approvals', icon: '✅' }
  ];

  return (
    <>
      <Helmet>
        <title>Municipal Services - Hayagriva Associates | Municipal Survey & Approval Services</title>
        <meta name="description" content="Professional municipal survey services including layout approvals, building plan verification, and property tax assessment in Telangana." />
      </Helmet>
          ...
          <div className="container-default w-full">
            <div className="max-w-3xl">
              ...
              <p className="text-xl sm:text-2xl text-white/95 leading-relaxed mb-8">
                Licensed to provide land surveying services for municipal projects and approvals
              </p>
        ...
        <div className="container-default">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <h2 className="text-4xl sm:text-5xl font-bold text-slate-900 mb-6">Municipal Services</h2>
              <div className="w-24 h-1 bg-brand-primary mx-auto mb-6"></div>
            </div>
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                <p className="text-xl text-slate-700 leading-relaxed">
                  We are <strong className="text-brand-primary">fully licensed and authorized</strong> to provide land surveying services for municipal projects and approvals. Our expertise includes municipal layout approvals, building plan verification, and property tax assessment.
                </p>
                <p className="text-lg text-slate-600 leading-relaxed">
                  Our team understands municipal requirements and ensures all surveys and documentation comply with municipal norms and regulations.
                </p>
              </div>
              <div className="bg-gradient-to-br from-brand-primary/10 via-brand-primary/5 to-slate-50 rounded-2xl p-8 border-2 border-brand-primary/20">
                <h3 className="text-2xl font-bold text-slate-900 mb-6">Why Choose Our Municipal Services?</h3>
                <div className="space-y-4">
                  {['Municipal license & authorization', 'Expert knowledge of regulations', 'Fast approval process', 'Complete documentation'].map((item, i) => (
      ...
      <AnimatedSection className="py-20 sm:py-24 bg-gradient-to-b from-slate-50 to-white">
        <div className="container-default">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl sm:text-5xl font-bold text-slate-900 mb-4">Municipal Services Offered</h2>
            <p className="text-xl text-slate-600 max-w-2xl mx-auto">
              Comprehensive municipal surveying and approval services
            </p>
        ...
        <div className="container-default">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <h2 className="text-4xl sm:text-5xl font-bold text-slate-900 mb-6">Complete Municipal Services</h2>
              <p className="text-xl text-slate-600">Full range of municipal surveying and approval services</p>
              <div className="w-24 h-1 bg-brand-primary mx-auto mt-6"></div>
            </div>
      ...
      <AnimatedSection className="py-20 sm:py-24 bg-gradient-to-b from-slate-50 to-white">
        <div className="container-default">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-600 max-w-2xl mx-auto">
              Systematic approach ensuring municipal compliance
            </p>
            <div className="w-24 h-1 bg-brand-primary mx-auto mt-6"></div>
          </div>
      ...
      <AnimatedSection className="py-20 sm:py-24 bg-gradient-to-br from-brand-primary via-brand-primary to-slate-800 text-white">
        <div className="container-default">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h2 className="text-4xl sm:text-5xl font-bold mb-6">Need Municipal Services?</h2>
            <p className="text-xl text-white/90 mb-10 max-w-2xl mx-auto leading-relaxed">
              Get professional municipal surveying and approval services. Contact us today.
            </p>
