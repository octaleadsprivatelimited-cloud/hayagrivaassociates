...
export default function EstimationCosting() {
  const features = [
    {
      icon: BanknotesIcon,
      title: 'Accurate Estimates',
      desc: 'Detailed and accurate cost estimation for construction projects',
      color: 'from-blue-500 to-blue-600'
    },
    {
      icon: ChartBarIcon,
      title: 'Material Costing',
      desc: 'Comprehensive material cost analysis and budgeting',
      color: 'from-purple-500 to-purple-600'
    },
    {
      icon: ClipboardDocumentListIcon,
      title: 'Labor Costing',
      desc: 'Detailed labor cost estimation and scheduling',
      color: 'from-green-500 to-green-600'
    },
    {
      icon: CheckCircleIcon,
      title: 'Budget Planning',
      desc: 'Complete budget planning and cost control support',
  ...
  const services = [
    ...
    'Revised estimates as needed'
  ];

  const process = [
    { step: '1', title: 'Project Review', desc: 'Review project plans and requirements', icon: ClipboardDocumentListIcon },
    { step: '2', title: 'Quantity Takeoff', desc: 'Calculate quantities of materials needed', icon: ChartBarIcon },
    { step: '3', title: 'Cost Analysis', desc: 'Analyze material and labor costs', icon: BanknotesIcon },
    { step: '4', title: 'Budget Preparation', desc: 'Prepare detailed budget breakdown', icon: Squares2X2Icon },
    { step: '5', title: 'Final Report', desc: 'Deliver comprehensive cost estimation report', icon: DocumentTextIcon }
  ];
    ...
    <>
      ...
      <section className="relative h-[50vh] sm:h-[60vh] lg:h-[70vh] overflow-hidden">
        ...
        <div className="absolute inset-0">
          <img
            src="/images/Estimation Costing.jpeg"
            alt="Estimation Costing"
          ...
          <div className="container-default w-full">
            <div className="max-w-3xl">
              ...
              <p className="text-xl sm:text-2xl text-white drop-shadow-lg leading-relaxed mb-8">
                Accurate cost estimation and budgeting for construction and development projects
              </p>
        ...
        <div className="container-default">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <h2 className="text-4xl sm:text-5xl font-bold text-slate-900 mb-6">Cost Estimation Services</h2>
              <div className="w-24 h-1 bg-brand-primary mx-auto mb-6"></div>
            </div>
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                <p className="text-xl text-slate-700 leading-relaxed">
                  We provide <strong className="text-brand-primary">accurate cost estimation</strong> and budgeting services for construction and development projects. Our detailed estimates help you plan and control project costs effectively.
                </p>
                <p className="text-lg text-slate-600 leading-relaxed">
                  Our team analyzes material costs, labor requirements, and project phases to provide comprehensive cost estimation that helps in budgeting and financial planning.
                </p>
              </div>
              <div className="bg-gradient-to-br from-brand-primary/10 via-brand-primary/5 to-slate-50 rounded-2xl p-8 border-2 border-brand-primary/20">
                ...
                <div className="space-y-4">
                  {['Accurate cost analysis', 'Detailed breakdown', 'Budget planning support', 'Ongoing cost control'].map((item, i) => (
      ...
      <AnimatedSection className="py-20 sm:py-24 bg-gradient-to-b from-slate-50 to-white">
        <div className="container-default">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl sm:text-5xl font-bold text-slate-900 mb-4">Estimation Services Offered</h2>
            <p className="text-xl text-slate-600 max-w-2xl mx-auto">
              Comprehensive cost estimation and budgeting services
            </p>
        ...
        <div className="container-default">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <h2 className="text-4xl sm:text-5xl font-bold text-slate-900 mb-6">Complete Estimation Services</h2>
              <p className="text-xl text-slate-600">Full range of cost estimation and budgeting services</p>
              <div className="w-24 h-1 bg-brand-primary mx-auto mt-6"></div>
            </div>
      ...
      <AnimatedSection className="py-20 sm:py-24 bg-gradient-to-b from-slate-50 to-white">
        <div className="container-default">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-600 max-w-2xl mx-auto">
              Systematic approach to cost estimation
            </p>
            <div className="w-24 h-1 bg-brand-primary mx-auto mt-6"></div>
          </div>
      ...
      <AnimatedSection className="py-20 sm:py-24 bg-gradient-to-br from-brand-primary via-brand-primary to-slate-800 text-white">
        <div className="container-default">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h2 className="text-4xl sm:text-5xl font-bold mb-6">Need Cost Estimation Services?</h2>
            <p className="text-xl text-white/90 mb-10 max-w-2xl mx-auto leading-relaxed">
              Get accurate cost estimation for your project. Contact us today.
            </p>
